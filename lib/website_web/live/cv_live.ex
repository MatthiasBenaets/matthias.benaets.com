defmodule WebsiteWeb.CvLive do
  ...
  @education [
    %{
      period: "2016-2019",
      name:
        "Bachelor Teacher Secondary Education:<br />English - Applied Informatics - ICT Coordinator",
      honor: "Cum laude",
      school: "PXL University College Hasselt",
      link: "https://www.uhasselt.be/en"
    },
    %{
      period: "2015-2016",
      name: "Bachelor Applied Informatics:<br />CCNA Networking Essentials Certified",
      school: "PXL University College Hasselt",
      link: "https://www.uhasselt.be/en"
    },
    %{
      period: "2009-2015",
      name: "Secondary Education:<br />Ecoomics and Modern Languages",
      school: "Virga Jessecollege Hasselt",
      link: "https://virgajessecollege.be/"
    }
  ]
  ...
  def mount(_params, _session, socket) do
    socket = assign(socket, page_title: "CV", experience: @experience, education: @education)
    {:ok, socket}
  end

  def handle_event("toggle_visibility", %{"index" => index}, socket) do
    index = String.to_integer(index)

    updated_experience =
      Enum.with_index(socket.assigns.experience)
      |> Enum.map(fn {exp, i} ->
        if i == index do
          Map.update!(exp, :visible, &(!&1))
        else
          exp
        end
      end)

    {:noreply, assign(socket, experience: updated_experience)}
  end
end
